...
class TestAffineGroup(unittest.TestCase):
    def test_inverse(self):
        ...
        self.assertEqual(AffineElement(affine_group, FFElement(0, 7), FFElement(1, 7)).inverse(),
                         AffineElement(affine_group, FFElement(0, 7), FFElement(1, 7)))

    def test_addition(self):
        elliptic_curve = EllipticCurveGroup(6, 2, 7)
        affine_group = AffineGroup(elliptic_curve)
        self.assertEqual(
            AffineElement(affine_group, FFElement(0, 7), FFElement(1, 7)) + AffineElement(affine_group, FFElement(6, 7),
                                                                                          FFElement(3, 7)),
    ...
    def test_element_order(self):
        ...
        self.assertEqual(AffineElement(affine_group, FFElement(0, 7), FFElement(1, 7)).calc_order(), 1)
    ...
    def test_tomer_group_order(self):
    ...
    def test_tomer_element_order(self):
        group = AffineGroup(EllipticCurveGroup(12, 25, 83))
        self.assertEqual(AffineElement(group, FFElement(0, 83), FFElement(1, 83)).calc_order(), 1)
        self.assertEqual(AffineElement(group, FFElement(0, 83), FFElement(5, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(0, 83), FFElement(78, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(1, 83), FFElement(11, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(1, 83), FFElement(72, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(5, 83), FFElement(25, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(5, 83), FFElement(58, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(6, 83), FFElement(8, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(6, 83), FFElement(75, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(7, 83), FFElement(28, 83)).calc_order(), 9)
        self.assertEqual(AffineElement(group, FFElement(7, 83), FFElement(55, 83)).calc_order(), 9)
        self.assertEqual(AffineElement(group, FFElement(11, 83), FFElement(34, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(11, 83), FFElement(49, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(15, 83), FFElement(29, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(15, 83), FFElement(54, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(20, 83), FFElement(31, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(20, 83), FFElement(52, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(22, 83), FFElement(8, 83)).calc_order(), 12)
        self.assertEqual(AffineElement(group, FFElement(22, 83), FFElement(75, 83)).calc_order(), 12)
        self.assertEqual(AffineElement(group, FFElement(24, 83), FFElement(39, 83)).calc_order(), 4)
        self.assertEqual(AffineElement(group, FFElement(24, 83), FFElement(44, 83)).calc_order(), 4)
        self.assertEqual(AffineElement(group, FFElement(26, 83), FFElement(20, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(26, 83), FFElement(63, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(27, 83), FFElement(19, 83)).calc_order(), 9)
        self.assertEqual(AffineElement(group, FFElement(27, 83), FFElement(64, 83)).calc_order(), 9)
        self.assertEqual(AffineElement(group, FFElement(28, 83), FFElement(22, 83)).calc_order(), 18)
        self.assertEqual(AffineElement(group, FFElement(28, 83), FFElement(61, 83)).calc_order(), 18)
        self.assertEqual(AffineElement(group, FFElement(29, 83), FFElement(32, 83)).calc_order(), 3)
        self.assertEqual(AffineElement(group, FFElement(29, 83), FFElement(51, 83)).calc_order(), 3)
        self.assertEqual(AffineElement(group, FFElement(30, 83), FFElement(24, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(30, 83), FFElement(59, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(31, 83), FFElement(15, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(31, 83), FFElement(68, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(33, 83), FFElement(2, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(33, 83), FFElement(81, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(34, 83), FFElement(35, 83)).calc_order(), 9)
        self.assertEqual(AffineElement(group, FFElement(34, 83), FFElement(48, 83)).calc_order(), 9)
        self.assertEqual(AffineElement(group, FFElement(35, 83), FFElement(34, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(35, 83), FFElement(49, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(37, 83), FFElement(34, 83)).calc_order(), 18)
        self.assertEqual(AffineElement(group, FFElement(37, 83), FFElement(49, 83)).calc_order(), 18)
        self.assertEqual(AffineElement(group, FFElement(38, 83), FFElement(18, 83)).calc_order(), 8)
        self.assertEqual(AffineElement(group, FFElement(38, 83), FFElement(65, 83)).calc_order(), 8)
        self.assertEqual(AffineElement(group, FFElement(42, 83), FFElement(0, 83)).calc_order(), 2)
        self.assertEqual(AffineElement(group, FFElement(43, 83), FFElement(6, 83)).calc_order(), 18)
        self.assertEqual(AffineElement(group, FFElement(43, 83), FFElement(77, 83)).calc_order(), 18)
        self.assertEqual(AffineElement(group, FFElement(44, 83), FFElement(9, 83)).calc_order(), 8)
        self.assertEqual(AffineElement(group, FFElement(44, 83), FFElement(74, 83)).calc_order(), 8)
        self.assertEqual(AffineElement(group, FFElement(47, 83), FFElement(9, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(47, 83), FFElement(74, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(49, 83), FFElement(30, 83)).calc_order(), 6)
        self.assertEqual(AffineElement(group, FFElement(49, 83), FFElement(53, 83)).calc_order(), 6)
        self.assertEqual(AffineElement(group, FFElement(55, 83), FFElement(8, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(55, 83), FFElement(75, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(56, 83), FFElement(41, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(56, 83), FFElement(42, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(57, 83), FFElement(27, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(57, 83), FFElement(56, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(58, 83), FFElement(6, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(58, 83), FFElement(77, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(59, 83), FFElement(40, 83)).calc_order(), 12)
        self.assertEqual(AffineElement(group, FFElement(59, 83), FFElement(43, 83)).calc_order(), 12)
        self.assertEqual(AffineElement(group, FFElement(61, 83), FFElement(22, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(61, 83), FFElement(61, 83)).calc_order(), 24)
        self.assertEqual(AffineElement(group, FFElement(65, 83), FFElement(6, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(65, 83), FFElement(77, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(75, 83), FFElement(9, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(75, 83), FFElement(74, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(77, 83), FFElement(22, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(77, 83), FFElement(61, 83)).calc_order(), 72)
        self.assertEqual(AffineElement(group, FFElement(82, 83), FFElement(26, 83)).calc_order(), 36)
        self.assertEqual(AffineElement(group, FFElement(82, 83), FFElement(57, 83)).calc_order(), 36)
